...
for i in features:
	for j in features[features.index(i)+1:]:
		...
		files, values = zip(*is_male_dict.items())
		...
		# print ("X", X.shape, "up = ",up.shape, "males = ",males.shape)
		# exit(1)
		
		
		# rating1 = file['p1_ips1']
		# rating2 = file['p1_hccq2a']
		# rating3 = file['p1_hccq3a']
		# rating4 = file['p1_hccq5a']
		# rating5 = file['p1_hccq1a']
